...
type FooHandler func(string, *v2.Foo) (*v2.Foo, error)
...
type FooClient interface {
	Create(*v2.Foo) (*v2.Foo, error)
	Update(*v2.Foo) (*v2.Foo, error)

	Delete(namespace, name string, options *metav1.DeleteOptions) error
	Get(namespace, name string, options metav1.GetOptions) (*v2.Foo, error)
	List(namespace string, opts metav1.ListOptions) (*v2.FooList, error)
	Watch(namespace string, opts metav1.ListOptions) (watch.Interface, error)
	Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (result *v2.Foo, err error)
}

type FooCache interface {
	Get(namespace, name string) (*v2.Foo, error)
	List(namespace string, selector labels.Selector) ([]*v2.Foo, error)

	AddIndexer(indexName string, indexer FooIndexer)
	GetByIndex(indexName, key string) ([]*v2.Foo, error)
}

type FooIndexer func(obj *v2.Foo) ([]string, error)
...
func (c *fooController) Updater() generic.Updater {
	return func(obj runtime.Object) (runtime.Object, error) {
		newObj, err := c.Update(obj.(*v2.Foo))
		if newObj == nil {
			return nil, err
		}
		return newObj, err
...
func UpdateFooDeepCopyOnChange(client FooClient, obj *v2.Foo, handler func(obj *v2.Foo) (*v2.Foo, error)) (*v2.Foo, error) {
	if obj == nil {
		return obj, nil
	}
...
func (c *fooController) Create(obj *v2.Foo) (*v2.Foo, error) {
	result := &v2.Foo{}
	return result, c.client.Create(context.TODO(), obj.Namespace, obj, result, metav1.CreateOptions{})
}

func (c *fooController) Update(obj *v2.Foo) (*v2.Foo, error) {
	result := &v2.Foo{}
...
func (c *fooController) Get(namespace, name string, options metav1.GetOptions) (*v2.Foo, error) {
	result := &v2.Foo{}
	return result, c.client.Get(context.TODO(), namespace, name, result, options)
}

func (c *fooController) List(namespace string, opts metav1.ListOptions) (*v2.FooList, error) {
	result := &v2.FooList{}
...
func (c *fooController) Patch(namespace, name string, pt types.PatchType, data []byte, subresources ...string) (*v2.Foo, error) {
	result := &v2.Foo{}
...
func (c *fooCache) Get(namespace, name string) (*v2.Foo, error) {
...
func (c *fooCache) List(namespace string, selector labels.Selector) (ret []*v2.Foo, err error) {
...
func (c *fooCache) AddIndexer(indexName string, indexer FooIndexer) {
	utilruntime.Must(c.indexer.AddIndexers(map[string]cache.IndexFunc{
		indexName: func(obj interface{}) (strings []string, e error) {
			return indexer(obj.(*v2.Foo))
		},
	}))
}

func (c *fooCache) GetByIndex(indexName, key string) (result []*v2.Foo, err error) {
	objs, err := c.indexer.ByIndex(indexName, key)
	if err != nil {
		return nil, err
	}
	result = make([]*v2.Foo, 0, len(objs))
	for _, obj := range objs {
		result = append(result, obj.(*v2.Foo))
	}
	return result, nil
}
